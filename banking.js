...
class Pages{
    static createBackground(){
        ...
        container.classList.add("vh-100", "bg-black", "d-flex", "justify-content-center", "align-items-center");
        return container;
    }
    ...
    static createIntialPage(){
        ...
        <div>
            ...
            <img src="images/DEA159CB-0BA7-4AAF-9A2A-6B3A60EE6F47.png" alt="" class="smallHum py-2">
        </div>
        <div>
            <p class="attention">↑ ↑ ↑</p>
        </div>
    ...
    static createMainGamePage(userData){
        ...
        <div class="bg-black d-flex justify-content-center align-items-center  px-5 py-4 col-12">
            <div class="col-5 text-center px-0 bg-orenge relative">     
                ...
                <img src="images/DEA159CB-0BA7-4AAF-9A2A-6B3A60EE6F47.png" alt="" class="hum py-2 ">
                <div class="fixed"> 
